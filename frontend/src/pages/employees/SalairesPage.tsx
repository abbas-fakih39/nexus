    ...
    <div className="flex flex-col gap-5">
      <div className="flex items-center justify-between">
        <p className="text-sm text-ink-mute">
          {payments.length} paiement{payments.length > 1 ? "s" : ""} · total
          versé{" "}
      ...
      <div className="overflow-hidden rounded-2xl border border-border bg-surface shadow-sm">
        <div className="overflow-x-auto">
          <table aria-label="Paiements de salaire" className="w-full text-sm">
            <thead>
            ...
            <tbody>
              {payments.map((p) => (
                ...
                >
                  ...
                  <td className="px-5 py-3 text-right font-mono tabular-nums font-semibold text-ink">
                    {formatEuro(p.amount)}
                  </td>
        ...
        {payments.length === 0 && (
          <div className="px-5 py-14 text-center text-sm text-ink-mute">
            {employees.length === 0
              ? "Créez d’abord une fiche employé."
      ...
      <Modal
        ...
        footer={
          <>
            ...
            <Button type="submit" form="salary-form" loading={saving}>
              Enregistrer
            </Button>
          </>
        }
      >
        ...
        >
          ...
          <Input
            ...
            placeholder="Prime, acompte… (optionnel)"
          />
