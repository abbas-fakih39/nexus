    ...
    <div className="flex flex-col gap-5">
                      ...
                      {a.status === "pending" && (
                        <>
                          <button
                            ...
                            className="rounded-lg px-2.5 py-1.5 text-[12px] font-semibold text-accent-deep transition hover:bg-accent-softer disabled:opacity-50"
                          >
                            Approuver
                          </button>
                          <button
      ...
      <Modal
        ...
        footer={
          <>
            ...
            <Button type="submit" form="absence-form" loading={saving}>
              Enregistrer
            </Button>
          </>
        }
      >
        ...
        >
          ...
          <Input
            label="Jours (laisser vide = calcul auto des jours ouvrés)"
            type="number"
            min="0.5"
            step="0.5"
            value={form.days}
          ...
          <p className="text-[12px] text-ink-faint">
            Une absence saisie par le gérant est directement approuvée.
          </p>
        </form>
      </Modal>
