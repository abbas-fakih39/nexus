              ...
              {pageItems.map((p) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-5 py-3 text-right font-mono font-semibold text-ink tabular-nums">
                      {formatEuro(p.price)}
                    </td>
                    <td
                      className={`px-5 py-3 text-right font-mono font-semibold tabular-nums ${st === "rupture" ? "text-danger" : st === "faible" ? "text-warn" : "text-ink"}`}
                    >
                      {p.stock}{" "}
                    ...
                    <td className="px-5 py-3 text-right font-mono text-ink-mute tabular-nums">
                      {p.alertThreshold}
                    </td>
                    <td className="px-5 py-3">
